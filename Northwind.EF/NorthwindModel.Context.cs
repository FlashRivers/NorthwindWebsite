...
namespace Northwind.EF
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int usp_InsEmployee(string lastName, string firstName, string homePhone)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_InsEmployee", lastNameParameter, firstNameParameter, homePhoneParameter);
        }
    
        public virtual ObjectResult<usp_SelEmployeesByLastName_Result> usp_SelEmployeesByLastName(string lastName)
        {
            var lastNameParameter = lastName != null ?
                new ObjectParameter("LastName", lastName) :
                new ObjectParameter("LastName", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SelEmployeesByLastName_Result>("usp_SelEmployeesByLastName", lastNameParameter);
        }
    }
}
